function ChannelTeleport( event )
	...
	local targetEntities = FindUnitsInRadius(caster:GetTeamNumber(), target_point, nil,
		FIND_UNITS_EVERYWHERE, DOTA_UNIT_TARGET_TEAM_FRIENDLY, DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_BUILDING, DOTA_UNIT_TARGET_FLAG_INVULNERABLE, FIND_ANY_ORDER, false)
  	local target = nil
