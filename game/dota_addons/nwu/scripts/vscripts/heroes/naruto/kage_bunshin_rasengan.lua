...
--local ability_index = keys.caster:FindAbilityByName("naruto_kage_bunshin_mastery"):GetAbilityIndex()
--local kage_bunshin_mastery_ability = keys.caster:GetAbilityByIndex(ability_index)
--local kage_bunshin_mastery_level = keys.caster:GetAbilityByIndex(ability_index):GetLevel()
--local tree_vision = kage_bunshin_mastery_ability:GetLevelSpecialValueFor("tree_vision", kage_bunshin_mastery_level)
